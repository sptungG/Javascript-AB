# Bài 29-30-31: Function cơ bản cho người mới
```js
...
// sum(argument): đối số
// ----------------------------------------------- -----------------------------------------------
// ----- Lưu function vào 1 biến r gọi sau này
...
# Bài 36-37-38: Bài tập về function số 1. *[mySolution](.\function-exercises)*
